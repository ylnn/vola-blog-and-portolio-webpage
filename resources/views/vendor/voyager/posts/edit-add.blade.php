                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="type"><b>Type (Post | Portfolio)</b></label>
                                <select class="form-control" name="type">
                                    <option value="POST"@if(isset($dataTypeContent->type) && $dataTypeContent->type == 'POST') selected="selected"@endif>Post</option>
                                    <option value="PORTFOLIO"@if(isset($dataTypeContent->type) && $dataTypeContent->type == 'PORTFOLIO') selected="selected"@endif>Portfolio</option>
                                </select>
                            </div>
                            <div class="form-group">
